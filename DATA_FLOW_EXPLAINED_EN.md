...
└─────────────────────────────────────────────────────────────────────────┘
    ...
    │  (triage/store.ts)       │  ✓ Record metadata
    │                          │  ✓ Store history
    └──────┬───────────────────┘
           │
           │ Response JSON
...
```typescript
// src/lib/triage/schemas.ts - input validation
...
### 📍 Location: `src/lib/triage/store.ts` and `src/app/api/admin/case-triage/[id]/analyze/route.ts`
...
└────────────────────────────────────────────────────────────────────┘
    ...
    ╚═══════════════════════════════════════════════╝
              ↓
    ╔═══════════════════════════════════════════════╗
    ║  LAYER 6: PERSISTENCE (triage/store.ts)      ║
...
↓
Saves to memory → `triage/store.ts` (persistence)
↓
...
- `src/lib/auth/index.ts` ← Access control
- `src/lib/triage/store.ts` ← Where data lives
